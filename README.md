...
- microUSB to USB cable (optional, and should already come with the camera). Useful for charging the camera, or in the case of Sony Imaging Edge Desktop, needed to connect to it
